...
def trading(trading_date,percent=percent, strategy_id= '机器学习1号', account1= 'name:client-1', working_dir= working_dir, ui_log= None):
    ...
    try:
        ...
        model_temp,info_temp = Stock.load_model('stock',working_dir = working_dir)
    except:
    ...
    tar,tar1 = Stock.model_predict(model_temp, str(trading_date[0:7])+"-01",trading_date,info_temp['cols'])
